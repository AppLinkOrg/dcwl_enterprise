...
export class MemberApi{
    ...
    checkrealname(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/checkrealname',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    list(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/list',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    shanghulist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/shanghulist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
